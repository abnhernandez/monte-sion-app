...
import { loginAction, getOAuthUrlAction } from "@/lib/auth-actions"
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <p className="text-sm text-muted-foreground">Inicia con correo o acceso rápido.</p>
        <p className="text-xs text-muted-foreground italic">Te tomará menos de un minuto.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-center text-[11px] text-muted-foreground">
          Al iniciar sesión aceptas los <Link href="/terminos" className="text-primary hover:underline">Términos</Link> y el <Link href="/privacidad" className="text-primary hover:underline">Aviso de Privacidad</Link>.
        </p>
      </div>
    </div>
  )
